...
**Project deadlines**: Project assigned on (Monday of) Week $X$ has deadline on Sunday evening of Week $X+1$, i.e. there are always 2 weeks per project.

## Evaluation

* 7 projects in total (for you to choose from)
    - specific data and tasks to perform
* 5 projects to be handed in
    - Project 1 is mandatory
    - at least one from Projects 2-3
    - at least one from Projects 4-5
    - at least one from Projects 6-7
* one of the projects (such that the conditions above are still met) can be replaced by presenting one of the first 4 upon teacher's consent
    - i.e. the presentations are voluntary

\bigskip
**Final grade**: each project will get a grade $g_i \in \{0,0.25,0.5,0.75,1\}$, $i=1,\ldots,5$, and the final grade will be
$$
1 + \sum g_i \in [1,6].
$$
