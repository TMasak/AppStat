---
title: "Week 4: Course Organization"
...
$$
f(y,\theta,\varphi) = \exp\left( \frac{y\theta-b(\theta)}{\varphi} + c(y,\phi) \right)
$$
...
* $U_n(\theta) := \frac{\partial}{\partial \theta} \log f(Y_n,\theta,\varphi) = \frac{Y_n\theta - b(\theta)}{\varphi}$
...
* $\ell(\theta) \propto \sum_n \exp\left( \frac{Y_n\theta - b(\theta)}{\varphi} \right)$, where
